...
class ClientResponse():
    ...
    def get_directories(self):
        ...
        """
        total = []
        for direc, files, sub in os.walk(os.path.join("data", self.username)):
    ...
    def file_info(self, directory):
        ...
        for i in os.listdir(directory):
            ...
            file_list.append([i, str(a.st_size), str(time.ctime(a.st_ctime))])
        return file_list
    ...
    def read_file(self, path):
        ...
        self.read_file_index[total_path] %= len(contents)//self.char_count + 1
